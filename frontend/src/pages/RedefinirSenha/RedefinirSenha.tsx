    ...
    <main className={styles.pageWrapper}>
      <div className={styles.contentCenter}>
        <div className={styles.containerBox}>
          {/* Identidade Topo SENAI */}
          <div className={styles.topIdentity}>
            <div className={styles.brandLogoBox}>
              <img src={senaiLogo} alt="Logomarca SENAI" />
            </div>
            <span className={styles.systemSubtitle}>
              SGA-D • Sistema de Gestão Disciplinar
            </span>
          </div>
          ...
          <div className={styles.resetCard}>
              ...
              <div className={styles.btnGroup}>
                <button
                  ...
                  className={`${styles.submitBtn} ${
                    successMessage ? styles.submitBtnSuccess : ""
                  }`}
                  disabled={
                    isSubmitting ||
                    !token ||
            ...
            {/* Badge de Criptografia SSL */}
            <div className={styles.trustBox}>
              <ShieldCheck size={16} color="var(--color-text-secondary)" />
              <span>Criptografia SSL 256-bit • Ambiente Seguro SENAI</span>
            </div>
          </div>

          {/* Bloco de Suporte Técnico */}
          <div className={styles.supportHelpBlock}>
            <div className={styles.supportLeft}>
              ...
              <div>
                <p className={styles.supportTitle}>Dúvidas ou problemas de acesso?</p>
                <p className={styles.supportDesc}>Contate a Central de TI SENAI: Ramal 4002</p>
              </div>
            </div>
            <a href="mailto:suporte.ti@sp.senai.br" className={styles.supportEmailLink}>
              <span>suporte.ti@sp.senai.br</span>
              <ExternalLink size={12} />
            </a>
          </div>

          {/* Rodapé Institucional Legal */}
          <footer className={styles.institutionalFooter}>
            <div className={styles.legalLinksRow}>
              <a href="#">Termos de Uso</a>
              <span>•</span>
              <a href="#">Política de Privacidade e LGPD</a>
              <span>•</span>
              <a href="#">Normas Regulamentares SENAI-SP</a>
            </div>
            <p>© 2025 SENAI-SP — Serviço Nacional de Aprendizagem Industrial. Todos os direitos reservados.</p>
          </footer>
        </div>
      </div>
    </main>
